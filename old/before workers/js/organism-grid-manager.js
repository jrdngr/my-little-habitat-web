define(["require", "exports", "grid", "organisms", "helpers", "queue"], function (require, exports, grid_1, organisms_1, helpers_1, queue_1) {
    "use strict";
    ...
    class OrganismGridManager {
        constructor(width, height, canvas, cellsPerStepMultiplier = 1) {
            ...
            this.turnQueue = new queue_1.Queue();
        ...
        step() {
            ...
            while (cellsProcessed < cellsPerStep) {
                if (this.turnQueue.hasNext()) {
                    let index = this.turnQueue.dequeue();
        ...
        addCellsToTurnQueue(cells) {
            cells.forEach(cell => {
                if (cell) {
                    this.turnQueue.enqueue(cell.y * this.grid.width + cell.x);
                }
            });
        }
